...
<h4>Datos Cliente</h4>
    <div class="col-md-4">
        ...
        <br>
        <label for="documento"><strong>Documento:</strong> '.$detalle['Documento'].'</label>
        <br>
        <label for="telefono"><strong>Telefono:</strong> '.$detalle['Telefono'].'</label>
        <br>
...
<table id="tabla">
    <thead>
        ...
        <th style="text-align:center;"colspan="3">Talla</th>
        <th style="text-align:center;"colspan="1">Cant.</th>
...
$tbl .= ' <tr>
        ...
        <td style="text-align:center;" colspan="3">'.$deta['Talla'].'</td>
        <td style="text-align:center;" colspan="1">'.$deta['Cantidad'].'</td>
...
<td style="text-align:center; " colspan="3">$'.$detalle['TotalIva'].'</td>
</tr>
